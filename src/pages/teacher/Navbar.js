...
const Navbar = () => {
  ...
  const mainNavLinks = [
    ...
    { to: "/teacher-children", icon: "fas fa-images", text: "Élèves" },
    { to: "/teacher-report", icon: "fas fa-user-tie", text: "Suggestions" },
    { to: "/teacher-feedback", icon: "fas fa-heart", text: "Commentaires" }
  ];
